...
class model_struct:
    ...
    def build(
        ...
        layer_structure = [
            ...
            {
                'layers': ['dense', 'conv', 'pool'],
                'weights': [32, 32, None],
                'depth': [nb_layers, None, None],
                'names': ['dense_2_1', 'conv_2_2', 'pool2'],
            ...
            },
            {
                ...
                'weights': [32, 32, None],
                'depth': [nb_layers, None, None],
                'names': ['dense_3_1', 'conv_3_2', 'pool3'],
                'filter_size': [3, 3, None]
            },
        ]
        ...
        layer_structure = [
            ...
            },
            {
                ...
                'weights': [32, 32, None],
                'depth': [nb_layers, None, None],
                'names': ['lrdense_2_1', 'lrconv_2_2', 'lrpool2'],
                'filter_size': [3, 3, None]
            }
        ]
