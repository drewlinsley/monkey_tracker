...
class model_struct:
    ...
    def build(
            self, image, output_categories=None,
        ...
        self.conv1 = self.conv_layer(
            image, int(image.get_shape()[-1]), 32,
            "conv1", filter_size=1)
