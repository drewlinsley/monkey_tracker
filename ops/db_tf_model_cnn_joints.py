        ...
        while not coord.should_stop():
            ...
            if step % config.steps_before_validation == 0:
                if validation_data is not False:
                    ...
                    validation_loss = val_out_dict['val_acc']
                else:
                ...
                db.update_parameters(
                    ...
                    ckpt_dir=ckpt_dir,
                    training_loss=train_out_dict['loss_value'],
                ...
                saver.save(
                    sess, ckpt_dir, global_step=step)
